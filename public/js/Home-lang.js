...
function setHomeContent(data, lang) {
  ...
  document.getElementById("sloganTopH3").innerText =
    sloganTop.title || "Loading...";
  document.getElementById("sloganTopLine1").innerText =
    sloganTop.line1 || "Json을 불러올 수 없습니다";
  document.getElementById("sloganTopLine2").innerText =
    sloganTop.line2 || "Can't load json files";

  document.getElementById("sloganMidH3").innerText =
    sloganMid.title || "Loading...";
  document.getElementById("sloganMidLine1").innerText =
    sloganMid.line1 || "Json을 불러올 수 없습니다";
  document.getElementById("sloganMidLine2").innerText =
    sloganMid.line2 || "Can't load json files";

  document.getElementById("sloganBotH3").innerText =
    sloganBot.title || "Loading...";
  document.getElementById("sloganBotLine1").innerText =
    sloganBot.line1 || "Json을 불러올 수 없습니다";
  document.getElementById("sloganBotLine2").innerText =
    sloganBot.line2 || "Can't load json files";
